...
With the an eye on the upcoming US presidential election of November 2020, let's take a look at some interesting data from the last one in 2016. Specifically, the dataset contains data regarding donors to Democratic and Republican candidates in the State of California, which has historically been a Democrat stronghold. Let's take a look at the data.
